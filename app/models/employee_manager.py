...
class EmployeeManager:
    ...
    def create_employee(full_name: str, gender: str, date_of_birth: date,
        ...
        """Create new employee using sp_add_employee"""
        conn = None
        cursor = None
        try:
    ...
    def update_employee(employee_id: int, full_name: str, phone: str,
        ...
        """Update employee using sp_update_employee"""
        conn = None
        cursor = None
        try:
            conn = DatabaseConnection.get_connection()
    ...
    def delete_employee(employee_id: int) -> Dict:
        """Delete employee using sp_delete_employee"""
        conn = None
        cursor = None
        try:
            conn = DatabaseConnection.get_connection()
...
class DepartmentManager:
    ...
    def update_department(department_id: int, department_name: str, location: str) -> Dict:
        """Update department using sp_update_department"""
        conn = None
        cursor = None
        try:
            conn = DatabaseConnection.get_connection()
    ...
    def delete_department(department_id: int) -> Dict:
        """Delete department with constraint check"""
        conn = None
        cursor = None
        try:
            conn = DatabaseConnection.get_connection()
...
class ProjectManager:
    ...
    def create_project(project_name: str, start_date: date, end_date: Optional[date],
        ...
        """Create new project using sp_add_project"""
        conn = None
        cursor = None
        try:
            conn = DatabaseConnection.get_connection()
    ...
    def update_project(project_id: int, project_name: str, end_date: Optional[date]) -> Dict:
        """Update project using sp_update_project"""
        conn = None
        cursor = None
        try:
            conn = DatabaseConnection.get_connection()
    ...
    def get_all_projects(status: Optional[str] = None) -> List[Dict]:
        """Get all projects using v_project_participation view
...
class AssignmentManager:
    ...
    def create_assignment(employee_id: int, project_id: int, 
        ...
        """Create assignment using sp_assign_project"""
        conn = None
        cursor = None
        try:
            conn = DatabaseConnection.get_connection()
...
class SalaryManager:
    ...
    def record_salary_payment(employee_id: int, month: str, 
        ...
        """Record salary payment using sp_record_salary_payment"""
        conn = None
        cursor = None
        try:
            conn = DatabaseConnection.get_connection()
    ...
    def calculate_salary(employee_id: int, month: str, year: int) -> Optional[Dict]:
        """Calculate salary using v_monthly_salary_summary view"""
        conn = None
        cursor = None
        try:
            conn = DatabaseConnection.get_connection()
...
class BonusDeductionManager:
    ...
    def get_bonus_deduction_by_employee(employee_id: int, 
        ...
        """Get bonus/deduction records for employee"""
        conn = None
        cursor = None
        try:
            conn = DatabaseConnection.get_connection()
